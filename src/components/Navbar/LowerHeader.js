    ...
    return (
      <React.Fragment>
        <Navbar bg="light" expand="lg">
          <Container>
            <Navbar.Brand className="main-heading" href="#home">Meteor</Navbar.Brand>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="mr-auto">
                ...
                <NavDropdown title="Lifestyle" id="basic-nav-dropdown">
                  ...
                  <NavDropdown.Item href="#culture/3.2">
                    Culture
                  </NavDropdown.Item>
                ...
                <NavDropdown title="Videos" id="basic-nav-dropdown">
                  ...
                  <NavDropdown.Item href="#culture/5.2">
                    Culture
                  </NavDropdown.Item>
              ...
              <Nav className="navbar-search mr-auto">
